/** v2.8.10 | MIT Licensed */ !(function (d) {
  "use strict";
  var t,
    h = d.document,
...
!(function (s) {
        ...
        i =
          "object" == typeof t
            ? layui.isArray(t)
              ? t
              : [t]
            : ((this.selector = t), l.querySelectorAll(t || null));
  ...
  ((r.fn = r.prototype = []),
    ...
    (h.hasScrollbar = function () {
      return (
        l.body.scrollHeight > (s.innerHeight || l.documentElement.clientHeight)
      );
    }),
    (h.position = function (t, e, n) {
      ...
      e &&
        ...
        (i = function (t) {
          return (
            l.body[(t = t ? "scrollLeft" : "scrollTop")] | l.documentElement[t]
          );
        }),
        (o = u.left),
        (c = u.bottom),
        "center" === n.align
          ? (o -= (a - t.offsetWidth) / 2)
          : "right" === n.align && (o = o - a + t.offsetWidth),
        (o =
          o + a + 5 >
          (r = function (t) {
...
!(function (i, v) {
  ...
  ((s.formatArr = function (e) {
    ...
    (I.prototype.position = function () {
      var e = this.config;
      return (
        lay.position(e.elem[0], this.elem, { position: e.position }),
        this
      );
    }),
  ...
  return (
    ...
    C.each(["top", "left"], function (e, n) {
      C.cssHooks[n] = ft(y.pixelPosition, function (e, t) {
        if (t)
          return ((t = p(e, n)), st.test(t) ? C(e).position()[n] + "px" : t);
      });
    }),
    ...
    i =
        ...
        (o
          .vessel(r, function (e, t, i) {
            (c.append(e[0]),
              ...
              s.scrollbar ||
                y.html.css("overflow", "hidden").attr("layer-full", l));
          })
          .auto(l),
          o.shadeo.css({
        ...
        (e.tips[1] || o.remove(),
          ...
          1 === n
            ...
            : 2 === n
              ...
              : 3 === n
                ? 0 <
                    a.top - d.scrollTop() + a.height + i[1] + 16 - d.height() &&
                  a.where[0]()
      ...
      (u.rescollbar = function (e) {
        y.html.attr("layer-full") == e &&
          (y.html[0].style.removeProperty
            ? y.html[0].style.removeProperty("overflow")
            : y.html[0].style.removeAttribute("overflow"),
      ...
      (h.full = function (t) {
        ...
        "max" !== e &&
          ...
          u.record(i),
          y.html.attr("layer-full") ||
            y.html.css("overflow", "hidden").attr("layer-full", t),
          setTimeout(function () {
    ...
    i = {
      fixbar: function (o) {
        var i,
          ...
          u =
            (o["default"] &&
              (o.bar1 && o.bars.push({ type: "bar1", icon: "layui-icon-chat" }),
              o.bar2 && o.bars.push({ type: "bar2", icon: "layui-icon-help" }),
              o.bars.push({ type: "top", icon: "layui-icon-top" })),
            s("<ul>").addClass(a));
        (layui.each(o.bars, function (e, t) {
          ...
          (n
            ...
            .attr({
              "lay-type": t.type,
              style:
                t.style || (o.bgcolor ? "background-color: " + o.bgcolor : ""),
            })
            .html(t.content),
            n.on("click", function () {
              var e = s(this).attr("lay-type");
              ("top" === e &&
                ("body" === o.target ? s("html,body") : c).animate(
                  { scrollTop: 0 },
                  o.duration,
                ),
                "function" == typeof o.click && o.click.call(this, e));
            }),
            "object" === layui.type(o.on) &&
              layui.each(o.on, function (e, t) {
                n.on(e, function () {
                  var e = s(this).attr("lay-type");
                  "function" == typeof t && t.call(this, e);
                });
              }),
            "top" === t.type && (n.addClass("layui-fixbar-top"), (i = n)),
            u.append(n));
        }),
          l.find("." + a).remove(),
        ...
        var i = arguments,
          a =
              ...
              (o.clock = i[2])),
            {
              ...
              reload: function (e) {
                (this.clear(),
                  s.extend(!0, this.options, { now: new Date() }, e),
                  r());
              },
            }),
          r =
            ("function" == typeof o.ready && o.ready(),
            (function l() {
      ...
      toDateString: function (e, t) {
        ...
        var n = this,
          ...
          i = [
            n.digit(o.getFullYear(), 4),
            n.digit(o.getMonth() + 1),
            n.digit(o.getDate()),
          ],
          n = [
            n.digit(o.getHours()),
            n.digit(o.getMinutes()),
            n.digit(o.getSeconds()),
          ];
        return o.getDate()
      ...
      openWin: function (e) {
        var t =
          (e = e || {}).window || window.open(e.url || "", e.target, e.specs);
        e.url ||
      ...
      toVisibleArea: function (e) {
        ...
        (e = s.extend({ margin: 160, duration: 200, type: "y" }, e))
          ...
          (r = t.offset()[o]),
          (c = {}),
          ((l = l.offset()[o] - r) > a - e.margin || l < e.margin) &&
            ((c[n] = l - a / 2 + i), t.animate(c, e.duration)));
      },
  ...
  ((k.prototype.config = {
    ...
    (k.prototype.init = function (e, i) {
      ...
      return 1 < l.length
        ? (layui.each(l, function () {
          ...
          n)
        : (s.extend(a, lay.options(l[0])),
          !e && l[0] && l.data(m)
            ? (t = y.getThis(l.data(m)))
              ? t.reload(a, i)
              : void 0
            : ((a.elem = s(a.elem)),
              ...
              (a.show ||
                ("reloadData" === i &&
                  n.elemView &&
                  s("body").find(n.elemView.get(0)).length)) &&
                n.render(e, i),
              void n.events()));
    }),
    (k.prototype.render = function (e, i) {
            ...
            layui.each(e, function (e, i) {
              ...
              ("-" === o || i.title || i.id || n) &&
                ...
                n &&
                  ...
                  (t = s("<ul></ul>")),
                  "parent" === o
                    ? (a.append(u(t, i.child)), l.append(a))
                    : l.append(u(t, i.child))),
                r.append(l));
            }),
            r
          );
      ...
      (!(e =
        ...
        d.elem.data(m + "_opened")) ||
        ((l.elemView = s("." + f + '[lay-id="' + d.id + '"]')),
    ...
    (k.prototype.remove = function () {
      ...
      var e = y.prevElem;
      (e &&
        (e.data("prevElem") && e.data("prevElem").data(m + "_opened", !1),
        e.remove()),
        lay("." + x).remove());
    }),
...
layui.define(["lay", "layer"], function (e) {
  ...
  ((L.prototype.config = {
      ...
      var t,
        ...
        s = function () {
          var i = 0,
            ...
            l = function () {
              u.multiple &&
                i + a === r.fileLength &&
                "function" == typeof u.allDone &&
                u.allDone({ total: r.fileLength, successful: i, failed: a });
            },
            t = function (t) {
              var n = new FormData(),
                e =
                  (layui.each(u.data, function (e, i) {
        ...
        d = function (e, i) {
          ...
          "function" == typeof u.done &&
            u.done(i, e || 0, function (e) {
              r.upload(e);
            });
        },
        m = function (e) {
          (u.auto && (l.value = ""),
            "function" == typeof u.error &&
              u.error(e || 0, function (e) {
                r.upload(e);
              }));
        },
        h = u.exts,
    ...
    (L.prototype.reload = function (e) {
      ...
      (e = this.config = x.extend({}, this.config, t.config, e)).elem
        .next()
                      ...
                      f = {
                        eye: {
                          ...
                          click: function (e, t) {
                            var i = "LAY_FORM_INPUT_AFFIX_SHOW",
                              a = e.data(i);
                            (e
                              .attr("type", a ? "password" : "text")
                              .data(i, !a),
                              l({ value: a ? "eye-invisible" : "eye" }));
                          },
                        },
                        clear: {
                          value: "clear",
                        ...
                        number: {
                          ...
                          click: function (e) {
                            ...
                            isNaN(i) ||
                              ((i = Number(i)),
                              n < (i = (i = t ? i - a : i + a) < l ? l : i) &&
                                (i = n),
                              (t = (
                                (a.toString().match(/\.(\d+$)/) || [])[1] || ""
                              ).length) && (i = i.toFixed(t)),
                              e.val(i));
                          },
                        },
                      };
                ...
                var s,
                  ...
                  r = C(
                    [
                      ...
                      (l ? " layui-select-disabled" : "") + '">',
                      '<div class="' + g + '">',
                      '<input type="text" placeholder="' +
                        d.escape(C.trim(t)) +
                        '" value="' +
                        d.escape(C.trim(n ? r.html() : "")) +
                        '"' +
                        (!l && o ? "" : " readonly") +
                        ' class="layui-input' +
                        (o ? "" : " layui-unselect") +
                  ...
                  function (a) {
                    ...
                    a.on("click", function () {
                      ...
                      l[0].disabled ||
                        ...
                        (l[0].checked = !0),
                        a.addClass(r + "ed"),
                        a.find(".layui-icon").addClass(n + " " + s[0]),
                ...
                layui.each(t, function (e, t) {
                  ...
                  if (a) {
                    var l =
                      ...
                      i = i || a[1];
                    if (
                      ("required" === t && (i = s.attr("lay-reqtext") || i),
                      l &&
                        (d.verIncludelRequired ||
                          "required" === t ||
                          (c && "required" !== t)))
                    )
                      return (
                        "tips" === o
                          ? y.tips(
                              i,
                              "string" != typeof s.attr("lay-ignore") && n
                                ? s.next()
                                : s,
                              { tips: 1 },
                            )
...
layui.define(["lay", "laytpl", "laypage", "form", "util"], function (n) {
  ...
  var p = layui.$,
        ...
        t &&
          (i =
            "function" == typeof t
              ...
              : m(p(t).html() || String(i)).render(
                  p.extend({ LAY_COL: a }, e.tplData),
                )),
    ...
    d =
      ...
      (i.prototype.render = function (e) {
        ...
        ((a.index = t.index),
          ...
          a.height && /^full-\d+$/.test(a.height)
            ? ((t.fullHeightGap = a.height.split("-")[1]),
              (a.height = O.height() - t.fullHeightGap))
            : a.height &&
              /^#\w+\S*-\d+$/.test(a.height) &&
              ((i = a.height.split("-")),
        ...
        (n
          .addClass(
            ((l = [R, R + "-" + t.index, "layui-form", "layui-border-box"]),
      ...
      (i.prototype.renderPagebar = function () {
        ...
        t.pagebar &&
          ((e = p(t.pagebar).html() || "") && a.append(m(e).render(t)),
      ...
      (i.prototype.setGroupWidth = function (i) {
        ...
        l.config.cols.length <= 1 ||
          ((e = l.layHeader.find(
            (i ? "th[data-key=" + i.data("parentkey") + "]>" : "") + "." + H,
          )).css("width", 0),
          ...
          t.renderData
            ? (((e = {})[d.dataName] = x.cache[l.key]),
              ...
              "object" == typeof n.totalRow &&
                (e[d.totalRowName] = p.extend({}, l.totalRow)),
              l.renderData({
                res: e,
                curr: a,
                count: e[d.countName],
            ...
            : n.url
              ...
              : "array" === layui.type(n.data) &&
                ...
                "object" == typeof n.totalRow &&
                  (e[d.totalRowName] = p.extend({}, n.totalRow)),
                (l.totalRow = e[d.totalRowName]),
                l.renderData({
                  res: e,
                  curr: a,
                    ...
                    ((t = [
                      ...
                      '<div class="layui-table-cell laytable-cell-' +
                        ...
                        (function () {
                          ...
                          return l.toolbar
                            ? m(p(l.toolbar).html() || "").render(t)
                            : w.call(s, { item3: l, content: n, tplData: t });
                        })(),
                      "</div></td>",
                    ].join("")),
                    i.push(t),
          ...
          r.eachCols(function (e, t) {
            var a,
              ...
              l =
                ...
                (n =
                  (t.totalRow &&
                    w.call(r, { item3: t, content: l, tplData: n })) ||
                  a),
                i || n),
              n =
                (t.field &&
      ...
      (i.prototype.setRowActive = function (e, t) {
        ...
        this.layBody
          ...
          .addClass((t = t || "layui-table-click"))
          .siblings("tr")
          .removeClass(t);
      }),
          ...
          i.autoSort &&
            ("asc" === l.type
              ...
              : "desc" === l.type
                ...
                : ((e = layui.sort(o, x.config.indexName, null, !0)),
                  delete t.sortKey,
                  delete i.initSort)),
      ...
      (i.prototype.fullSize = function () {
        var e,
          ...
          l = t.height;
        (i.fullHeightGap
          ? (l = O.height() - i.fullHeightGap) < 135 && (l = 135)
          : i.parentDiv &&
            i.parentHeightGap &&
            (l = p(i.parentDiv).height() - i.parentHeightGap) < 135 &&
            (l = 135),
          1 < t.cols.length &&
      ...
      (i.prototype.scrollPatch = function () {
        ...
        (e.layFixed.find(D).css("height", t.height() >= n ? n : "auto"),
          e.layFixRight[
            x.cache[e.key] && x.cache[e.key].length && 0 < l
              ? "removeClass"
              : "addClass"
          ](N),
          ...
          c =
                ...
                case "LAYTABLE_PRINT":
                  ...
                  (d.append(s.layMain.find("table").html()),
                    ...
                    layui.device("edg").edg
                      ? ((n.onafterprint = n.close), n.print())
                      : (n.print(), n.close()));
              }
              layui.event.call(
                this,
            ...
            s.layHeader.on("click", "*[lay-event]", function (e) {
              ...
              layui.event.call(
                ...
                T,
                "colTool(" + r + ")",
                p.extend({ event: a, config: u, col: t }, {}),
              );
            }),
            ...
            k.docEvent ||
              P.on("mousemove", function (e) {
                ...
                var t, a, i, l, n;
                k.eventMoveElem &&
                  ((i = (t = k.eventMoveElem).closest("." + R).attr("lay-id")),
                  (a = C(i)) &&
                    ((i = t.data("key")),
                    (l = a.col(i)),
          ...
          a =
            ...
            s.layBody
              ...
              .on("click", "tr", function (e) {
                var t =
                  ".layui-form-checkbox,.layui-form-switch,.layui-form-radio,[lay-unrow]";
                p(e.target).is(t) ||
                  p(e.target).closest(t)[0] ||
                  a.call(this, "row");
              })
      ...
      function (a, i, e, l) {
        ...
        l.colGroup &&
          ...
          layui.each(i[o], function (e, t) {
            t.parentKey
              ? t.parentKey === l.key &&
                ((t.PARENT_COL_INDEX = a), l.CHILD_COLS.push(t), d(a, i, o, t))
              : t.PARENT_COL_INDEX ||
                (1 <= n && n == (l.colspan || 1)) ||
  ...
  ((x.eachCols = function (e, a, i) {
          ...
          layui.each(t, function (i, l) {
            ...
            ("object" == typeof e
              ? (layui.each(e, function (e, t) {
                ...
                layui.each(
                  layui.isArray(l) ? p.extend([], l) : x.clearCacheKey(l),
                  function (e, t) {
                    n.push('"' + (t || "") + '"');
                  },
                ))
    ...
    (x.clearCacheKey = function (e) {
      return (
        delete (e = p.extend({}, e))[x.config.checkName],
...
layui.define(["table"], function (e) {
        ...
        ? (e && (!o || o.mod)) ||
          ((a.parseData = function () {
            var e = this,
              ...
              a = t[0],
              t =
                ("function" === layui.type(o) && (a = o.apply(e, t) || t[0]),
                e.response.dataName);
            return (
              n.data.isSimpleData &&
                !n["async"].enable &&
                (a[t] = l.flatToTree(a[t])),
              p(
                a[t],
                function (e) {
                  e[X] =
                    X in e ? e[X] : e[d] !== undefined && l.status.expand[e[d]];
                },
                r,
              ),
              e.autoSort &&
        ...
        (e && (!c || c.mod)) ||
          ((a.done = function () {
            var e,
              ...
              n =
                (l.updateStatus(null, { LAY_HAS_EXPANDED: !1 }),
                u(i, r),
                a.find(
  ...
  ((t.prototype.init = function () {
    var e = this.config,
      t = j.render(B.extend({}, e, { data: [], url: "", done: null })),
      a = t.config.id;
          ...
          n && !p
            ? (layui.each(v, function (e, t) {
              ...
              r
                ...
                .addClass(q))
            : ((C = c.treeToFlat(v, y[s.id], e)),
              r
                .find(
                  C.map(function (e, t, a) {
                    return 'tr[lay-data-index="' + e[H] + '"]';
                  }).join(","),
                )
                .addClass(q)));
    ...
    r =
      ...
      (P.sort = function (e) {
        var t,
          a = F(e);
        !a ||
          ((t = a.getOptions()).url && !t.autoSort) ||
          (a.initData(), P.renderData(e));
      }),
      function (n) {
        var t = n.config.id,
          i = F(t),
    ...
    o =
      ...
      (P.addNodes = function (e, t) {
        ...
        if (a) {
          var n = a.getOptions(),
            ...
            o = t.data,
            t = t.focus,
            c = (r = "number" === layui.type(r) ? r.toString() : r)
          ...
          if (c) {
            ...
            c[u] = !0;
            var f = (f = c[s])
                ? ((y = f.splice(-1 === d ? f.length : d)),
                  (c[s] = f.concat(o, y)))
                : (c[s] = o),
              s =
                (a.updateStatus(f, function (e) {
            ...
            if (
              ((j.cache[e] = j.cache[e].concat(o, y)),
              n.url ||
                (n.page
                  ? ((f = n.page),
                    n.data.splice.apply(
                      n.data,
                      [f.limit * (f.curr - 1), f.limit].concat(j.cache[e]),
                    ))
                  : (n.data = j.cache[e])),
              a.initData(),
              l.find(".layui-none").length)
            )
              return (j.renderData(e), o);
            var p,
              s = j.getTrHtml(e, o),
              x = {
                trs: B(s.trs.join("")),
              ...
              s = l.find(R);
            (-1 == r
              ? (f.find('tr[data-level="0"][data-index="0"]').before(x.trs),
                n
                  .find('tr[data-level="0"][data-index="0"]')
                  .before(x.trs_fixed),
                s
                  .find('tr[data-level="0"][data-index="0"]')
                  .before(x.trs_fixed_r))
              : -1 === d
                ? (f.find("tbody").append(x.trs),
                  n.find("tbody").append(x.trs_fixed),
                  s.find("tbody").append(x.trs_fixed_r))
                : ((r = y[0][m]),
                  f
          ...
          return (
            a.updateCheckStatus(c),
            P.resize(e),
            t &&
              l
                .find(L)
                .find('tr[lay-data-index="' + o[0][H] + '"]')
                .get(0)
      ...
      (t.prototype.updateCheckStatus = function (e, t) {
        var a = this.getOptions(),
          ...
          r =
            (e &&
              ((a = this.updateParentCheckStatus(
                e,
          ...
          d = !1;
        return (
          layui.each(j.cache[n], function (e, t) {
            ((t[l] || t[b]) && (d = !0), t[l] || (r = !1));
          }),
          (d = d && !r),
          x.render(
            i
              ...
              .prop({ checked: r, indeterminate: d }),
          ),
          r
        );
      }),
      (t.prototype.updateParentCheckStatus = function (a, n) {
        ...
        return (
          ...
          r.push(B.extend({}, a)),
          (r = a[f]
            ? r.concat(this.updateParentCheckStatus(j.cache[e][a[f]], n))
            : r)
        );
      }),
      function (e, t, a) {
        ...
        if (a) {
          ...
          o
            ? t && !d.prop("checked") && a()
            : ("boolean" === layui.type(t) && d.prop("checked") === t) || a();
        } else {
          var c,
          ...
          if (!o)
            return (
              ...
              (i = r.find(
                ...
                .closest("tr")
                [t ? "addClass" : "removeClass"](s),
              x.render(i.prop({ checked: t, indeterminate: !1 })),
  ...
  (P.on("checkbox", function (e) {
    var t = e.config,
      ...
      t = t.id;
    a.hasClass(h) &&
      ((a = F(t)), (t = e.checked), r(e), (e.isAll = o.call(a, e.tr, t)));
  }),
      ...
      d &&
        ...
        (l = d.getNodeDataByIndex(i)) &&
          ((r = a.find('tr[lay-data-index="' + i + '"]')).length ||
            (P.expandNode(e, { index: l[f], expandFlag: !0 }),
...
(layui.define(["lay", "util", "element", "form"], function (e) {
  ...
  e("code", function (e) {
    ...
    ((e.elem = C(e.elem)),
      e.elem[0] &&
        layui.each(e.elem.get().reverse(), function (e, a) {
          var t,
            l,
            i,
            o,
            ...
            h =
              ("function" == typeof f.codeParse && (a = l = f.codeParse(a)),
              {
                copy: {
                  className: "file-b",
                  title: ["\u590d\u5236\u4ee3\u7801"],
            ...
            m =
              (f.preview &&
                ...
                C.extend(h, {
                  full: {
                    ...
                    event: function (e, a) {
                      ...
                      e.hasClass(t)
                        ? (i.addClass(x.ELEM_FULL),
                          e.removeClass(t).addClass(l),
                          e.attr("title", o[1]),
                          n.addClass(s))
                        : (i.removeClass(x.ELEM_FULL),
                ...
                f.copy &&
                  ("array" === layui.type(f.tools)
                    ? -1 === f.tools.indexOf("copy") && f.tools.unshift("copy")
                    : (f.tools = ["copy"])),
                ...
                "preview" === E[0]
                  ? (c.addClass(x.ELEM_SHOW), p.before(c), r(c))
                  : p.addClass(x.ELEM_SHOW).after(c),
          ...
          (p.addClass("layui-code-view layui-box"),
            f.skin &&
              ("notepad" === f.skin && (f.skin = "dark"),
              p.removeClass("layui-code-dark layui-code-light"),
              p.addClass("layui-code-" + f.skin)),
            (a = (a = f.encode ? w.escape(a) : a).replace(
              /[\r\t\n]+/g,
              "</li><li>",
            )),
            p.html(L.html("<li>" + a + "</li>")),
            f.header &&
              !p.children("." + x.ELEM_TITLE)[0] &&
              (M.html(
                (f.title || f.text.code) +
                  (f.about
                    ? '<div class="layui-code-about">' + f.about + "</div>"
                    : ""),
              ),
              p.prepend(M)),
            f.elem.length === e + 1 &&
              ...
              f.allDone(),
            0 < (u = Math.floor(L.find("li").length / 100)) &&
              L.css("margin-left", u + "px"),
            ...
            f.copy &&
              ...
              ((y = C(
                [
                  '<span class="' + x.ELEM_COPY + '">',
                  '<i class="layui-icon layui-icon-file-b" title="\u590d\u5236"></i>',
                  "</span>",
                ].join(""),
              )),
              (E = p.children("." + x.ELEM_COPY)),
              (L[0].style.height || L[0].style.maxHeight) &&
                y.addClass(x.ELEM_COPY + "-offset"),
              E[0] && E.remove(),
              p.append(y),
              y.on("click", function () {
                h.copy.event();
